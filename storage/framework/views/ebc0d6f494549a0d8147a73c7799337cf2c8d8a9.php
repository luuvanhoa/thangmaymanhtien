	...
	<script data-pace-options='{ "restartOnRequestAfter": true }' src="<?php echo e(URL::to('js/plugin/pace/pace.min.js')); ?>"></script>
	...
	<script>
		if (!window.jQuery) {
			document.write('<script src="<?php echo e(URL::to("js/libs/jquery-2.0.2.min.js")); ?>"><\/script>');
		}
	</script>
	...
	<script>
		if (!window.jQuery.ui) {
			document.write('<script src="<?php echo e(URL::to("js/libs/jquery-ui-1.10.3.min.js")); ?>"><\/script>');
		}
	</script>

	<!-- IMPORTANT: APP CONFIG -->
	<?php echo Html::script('js/app.config.js'); ?>
	...
	<?php echo Html::script('js/plugin/fastclick/fastclick.min.js'); ?>
	...
	<!-- Demo purpose only -->
	<?php echo Html::script('js/demo.min.js'); ?>
	...
	<?php echo Html::script('js/speech/voicecommand.min.js'); ?>

	<!-- PAGE RELATED PLUGIN(S) -->

	<!-- Flot Chart Plugin: Flot Engine, Flot Resizer, Flot Tooltip -->

	<?php echo Html::script('js/plugin/flot/jquery.flot.cust.min.js'); ?>


	<?php echo Html::script('js/plugin/flot/jquery.flot.resize.min.js'); ?>


	<?php echo Html::script('js/plugin/flot/jquery.flot.tooltip.min.js'); ?>
	...
	<?php echo Html::script('js/loiphat.js'); ?>
