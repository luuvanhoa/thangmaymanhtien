...
<html lang="en-us">
	<head>
		...
		<?php echo Html::style('css/smartadmin-production.min.css'); ?>

		<?php echo Html::style('css/smartadmin-skins.min.css'); ?>

		<?php echo Html::style('css/demo.min.css'); ?>

		<?php echo Html::style('css/your_style.css'); ?>
	...
	<body>
		...
		<header id="header">
			<div id="logo-group">
				<span id="logo"><?php echo Html::image('img/logo.png', 'SmartAdmin'); ?></span>
			</div>
